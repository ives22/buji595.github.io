...
![elk02.png](ELK快速入门-基本部署/elk02.png)
...
3）测试提交数据
![elk05.png](ELK快速入门-基本部署/elk05.png)

4）验证索引是否存在
![elk06.png](ELK快速入门-基本部署/elk06.png)
...
```
### 查看状态
![elk09.png](ELK快速入门-基本部署/elk09.png)
...
![elk13.png](ELK快速入门-基本部署/elk13.png)
